...
public:
    ...
    static NonnullRefPtr<WebSocketImplCurl> create(CURLM* multi) { return adopt_ref(*new WebSocketImplCurl(multi)); }
...
private:
    ...
    static size_t curl_write_callback(char* buffer, size_t size, size_t num_items, void* user_data);
